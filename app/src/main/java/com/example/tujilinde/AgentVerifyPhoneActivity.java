...
public class AgentVerifyPhoneActivity extends AppCompatActivity {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(AgentVerifyPhoneActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(AgentVerifyPhoneActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(AgentVerifyPhoneActivity.this, AgentProfileActivity.class);
                            ...
                            Toast.makeText(AgentVerifyPhoneActivity.this, "Verification failed", Toast.LENGTH_SHORT).show();
